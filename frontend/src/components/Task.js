    ...
    return (
        <div className='px-12 py-6 w-full'>
            <div className="flex items-center justify-between mb-6">
                ...
                <BtnPrimary onClick={() => setAddTaskModal(true)}>Agregar tarjeta</BtnPrimary>
            </div>
            <DragDropContext
                                                                    ...
                                                                    return (
                                                                        ...
                                                                        >
                                                                            <div className="pb-2">
                                                                                ...
                                                                                <p className="text-xs text-slate-500 leading-4 -tracking-tight" index="item.index">{item.description.slice(0, 60)}{item.description.length > 60 && '...'}</p>
                                                                                <span className="py-1 px-2.5 bg-indigo-100 text-indigo-600 rounded-md text-xs font-medium mt-1 inline-block">Me gusta</span>
                                                                            </div>
                                                                        </div>
                                                                    );
                                                                }}
